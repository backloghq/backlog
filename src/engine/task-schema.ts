...
const SCHEMA_DEF = {
  ...
  fields: {
    ...
    description: { type: "string" as const, required: true, maxLength: 500, searchable: true, description: "Free-text task description (max 500 chars). One-line summary of what needs doing — used in listings, BM25 search, and standups. For acceptance criteria, requirements, technical context, or anything longer than a sentence or two, keep this short and attach a markdown spec via task_doc_write." },
