 ...
 */
export const VERIFY_ID_NOTE =
  " Before passing a numeric ID or UUID to this tool, confirm it exists in the current backlog state via task_list or task_info — do not rely on IDs from prior sessions, memory, or the user's recall, since tasks may have been deleted, completed, or never existed.";
