...
export declare function addTask(_config: EngineConfig, description: string, attrs: Record<string, string | boolean>, extraArgs?: string[]): Promise<string>;
export declare function modifyTask(_config: EngineConfig, filter: string, attrs: Record<string, string | boolean>, extraArgs?: string[]): Promise<string>;
